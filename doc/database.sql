...
--
-- Host: localhost
-- Generation Time: Jan 27, 2014 at 11:44 AM
...
('root', '[{"db":"blog","table":"user"},{"db":"blog","table":"post"},{"db":"webauth","table":"user_pwd"},{"db":"phpmyadmin","table":"pma_column_info"},{"db":"phpmyadmin","table":"pma_designer_coords"},{"db":"phpmyadmin","table":"pma_history"},{"db":"phpmyadmin","table":"pma_pdf_pages"},{"db":"phpmyadmin","table":"pma_recent"},{"db":"phpmyadmin","table":"pma_relation"},{"db":"cdcol","table":"cds"}]');
...
('root', '2013-09-05 10:13:57', '{"lang":"et"}');
